    ...
    >
      ...
      >
        ...
        <p class="mt-4 text-center text-base sm:text-lg leading-relaxed text-gray-600 max-w-xl mx-auto">
          Thank you! Your technician application has been submitted. Our team
          will review it and reach out within a few business days.
        </p>
        ...
        <ul class="mt-8 space-y-5 sm:space-y-6">
          <li class="flex gap-4 sm:gap-5">
            ...
            <div class="flex-1 min-w-0">
              ...
              <p class="mt-1 text-sm sm:text-base text-gray-600 leading-relaxed">
                Our hiring team carefully reviews every application we receive
          ...
          <li class="flex gap-4 sm:gap-5">
            ...
            <div class="flex-1 min-w-0">
              ...
              <p class="mt-1 text-sm sm:text-base text-gray-600 leading-relaxed">
                If your background is a match, we'll reach out within a few
                business days to schedule a conversation.
              </p>
            </div>
          </li>
        </ul>
...
<script setup>
useHead({
  title: 'Application Received | Easy Fix Appliance',
  meta: [
    { name: 'robots', content: 'noindex, nofollow' },
    {
      name: 'description',
      content:
        "Thanks for applying to Easy Fix Appliance. Our team is reviewing your application and will reach out soon."
    }
  ]
});
</script>
