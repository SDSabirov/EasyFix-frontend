        ...
        >
          ...
          <ul role="list" class="mb-8 space-y-4 text-left text-white">
            ...
            <li class="flex items-center space-x-3">
              ...
              <span>Genuine Parts for Lasting Fixes </span>
            </li>
            <li class="flex items-center space-x-3">
              <!-- Icon -->
              <svg
              ...
              <span
                ...
                <span class="font-semibold"
                  >at most convenient time for you</span
                ></span
              >
            </li>
            <li class="flex items-center space-x-3">
              ...
              <span
                >Rapid Response Times<span class="font-semibold"></span
              ></span>
            </li>
            <li class="flex items-center space-x-3">
              <!-- Icon -->
              ...
              <span
                >Experienced Technicians<span class="font-semibold"></span
              ></span>
            </li>
          </ul>
          <NuxtLink
        ...
        >
          ...
          <ul role="list" class="mb-8 space-y-4 text-left text-white">
            ...
            <li class="flex items-center space-x-3">
              ...
              <span>Available <span class="font-semibold">24/7</span></span>
            </li>
            <li class="flex items-center space-x-3">
              <!-- Icon -->
              <svg
