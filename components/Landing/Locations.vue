<template>
  <section class="bg-gradient-to-br from-gray-50 to-white py-16 lg:py-24">
    <div class="container mx-auto px-4 max-w-screen-xl">
      ...
      <!-- Service Areas Grid -->
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 mb-16">
        <!-- Cities Section -->
      ...
      <!-- Call to Action -->
      <div class="bg-gradient-to-r from-primary to-secondary rounded-3xl p-5 sm:p-8 text-center text-white">
