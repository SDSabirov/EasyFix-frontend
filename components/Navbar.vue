<template>
  <nav
    :class="[
      'transition-all duration-500 fixed w-full z-50 top-0 start-0 font-montserrat',
      route.path !== '/' 
  ...
  >
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto px-4 py-3">
      ...
      <button
        ...
        class="lg:hidden p-3 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 transition-all duration-300 min-h-[44px] min-w-[44px] touch-manipulation"
