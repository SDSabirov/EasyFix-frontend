<template>
  ...
  <nav class="bg-transparent transition-all duration-500 dark:bg-gray-900 fixed w-full z-40 top-0 start-0  dark:border-gray-600">
    ...
    <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
        <div class="space-x-2 md:space-x-4">
          <button type="button" class="text-primary bg-light border hover:border hover:border-tertiary  hover:text-white hover:bg-secondary transition-all duration-800 ease-out focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium  text-sm px-4 py-2 text-center  "
        ...
        <!--call now buuron-->
        <a type="button" 
          class="text-primary bg-light border hover:border hover:border-tertiary  hover:text-white hover:bg-secondary transition-all duration-800 ease-out focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium  text-sm px-4 py-2 text-center md:hidden "
           href="tel:+1234567890"
        >
            Call now
        </a>
