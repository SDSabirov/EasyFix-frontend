<template>
  <div>
    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6 animate-fadeInLeft">
      <!-- First Name -->
      <div class="w-full">
        <label for="name" class="block mb-2 text-sm font-medium text-primary" :class="{'text-red-500': Errors.firstName}">
          First Name
        </label>
        <small class="text-red-500" v-if="Errors.firstName">Required field!</small>
        <input
      ...
      <!-- Last Name -->
      <div class="w-full">
        <label for="last-name" class="block mb-2 text-sm font-medium text-primary" :class="{'text-red-500': Errors.lastName}">
          Last Name
        </label>
        <small class="text-red-500" v-if="Errors.lastName">Required field!</small>
        <input
      ...
      <!-- Email -->
      <div class="w-full">
        <label for="email" class="block mb-2 text-sm font-medium text-primary" :class="{'text-red-500': Errors.email}">
          Email
        </label>
      ...
      <!-- Phone -->
      <div class="w-full">
        <label for="phone-input" class="block mb-2 text-sm font-medium text-primary" :class="{'text-red-500': Errors.phone}">
          Phone Number
        </label>
      ...
      <!-- Address -->
      <div class="w-full">
        <label for="address" class="block mb-2 text-sm font-medium text-primary" :class="{'text-red-500': Errors.address}">
          Address
        </label>
        <small class="text-red-500" v-if="Errors.address">Required field!</small>
        <input
      ...
      <!-- Zip/Postal Code -->
      <div class="w-full">
        <label for="zip" class="block mb-2 text-sm font-medium text-primary" :class="{'text-red-500': Errors.zip}">
          Zip/Postal Code
        </label>
