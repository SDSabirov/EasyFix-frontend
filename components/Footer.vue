        ...
        <div class="lg:col-span-2">
          <div class="flex items-center space-x-3 mb-6">
            ...
            <div>
              <div class="flex items-baseline">
                ...
                <span class="text-2xl font-bold text-tertiary">Fix</span>
              </div>
          ...
          <div class="space-y-3">
            <div class="flex items-center space-x-3">
              ...
              <a href="tel:4159414144" class="text-white hover:text-tertiary transition-colors py-2 min-h-[44px] touch-manipulation inline-block">(415) 941-4144</a>
            </div>
            <div class="flex items-center space-x-3">
              <svg class="w-5 h-5 text-primary" fill="currentColor" viewBox="0 0 20 20">
              ...
              <a href="mailto:care@easyfixappliance.com" class="text-white hover:text-tertiary transition-colors py-2 min-h-[44px] touch-manipulation inline-block break-all">care@easyfixappliance.com</a>
            </div>
            <div class="flex items-center space-x-3">
              <svg class="w-5 h-5 text-primary" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <div class="space-y-2 text-gray-300">
              ...
              <p class="text-tertiary font-medium">Emergency Service: 24/7</p>
            </div>
          </div>
      ...
      <div class="pt-8 border-t border-gray-700">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
          <div class="text-gray-400 text-sm">
            © 2024 <span class="text-white font-medium">Easy Fix Appliance™</span>. All Rights Reserved.
          </div>
