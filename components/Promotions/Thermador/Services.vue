<template>
  <section class="w-full bg-white relative">
    <img
      src="/assets/img/promotions/pattern.png"
    ...
    <div class="w-full max-w-screen-xl mx-auto flex flex-col py-10 z-10">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 px-2 md:px-0 py-12">
        <div class="flex flex-col space-y-6">
          ...
          >
            Precision Service for <br /><span class="text-red-700"
              >High-Performance Kitchens</span
            >
          </h1>
        </div>
        <div
        ...
        >
          <p>
            Thermador appliances are known for their innovation, power, and
            sleek design, making them a top choice for luxury kitchens. When
            your Thermador range, oven, or refrigerator needs service, you need
            skilled professionals who understand their advanced engineering. At
            Easy Fix Appliance, we specialize in repairing Thermador appliances,
            ensuring they continue to perform flawlessly.
          </p>
        </div>
      </div>
      <div
      ...
      >
        ...
        >
          ...
          >
            <img src="/assets/icons/promotions/user.png" alt="user icon" />
          </div>
        ...
        >
          <div
            class="rounded-full w-[70px] h-[70px] flex items-center justify-center bg-primary"
          >
            <img src="/assets/icons/promotions/wrench.png" alt="wrench icon" />
          </div>
          <h2 class="text-2xl text-primary font-semibold">
        ...
        >
          <div
            class="rounded-full w-[70px] h-[70px] flex items-center justify-center bg-primary"
          >
            <img src="/assets/icons/promotions/house.png" alt="house icon" />
          </div>
          <h2 class="text-2xl text-primary font-semibold">
        ...
        >
          <div
            class="rounded-full w-[70px] h-[70px] flex items-center justify-center bg-primary"
          >
            <img src="/assets/icons/promotions/iconx2.png" alt="house icon" />
          </div>
          <h2 class="text-2xl text-primary font-semibold">
