<template>
  <section class="w-full bg-white relative">
    ...
    <div class="w-full max-w-screen-xl mx-auto flex flex-col py-10 z-10">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 px-2 md:px-0 py-12">
        ...
        >
          ...
          <p>
            ...
            the go-to experts for Viking ranges, ovens, refrigerators, and
            freezers. We know these appliances inside and out and are committed
            to keeping them running smoothly, so your kitchen stays hassle-free.
          </p>
        </div>
      </div>
      <div
      ...
      <div class="grid grid-cols-1 gap-6 md:grid-cols-3 px-2 mx-auto md:px-0 mt-6">
        <div
        ...
        >
          ...
          <p>We stand behind our work. Get up to 3 years of warranty coverage on select repairs.</p>
        </div>
      </div>
