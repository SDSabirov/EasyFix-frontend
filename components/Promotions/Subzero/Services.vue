      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 px-2 md:px-0 py-12">
        <div class="flex flex-col space-y-6">
          ...
          >
            Why Choose Easy Fix for Your <br /><span class="text-red-700"
              >Sub-Zero Appliance Repairs?</span
            >
          </h1>
        </div>
        <div
        ...
        >
          <p>
            ...
            the go-to experts for Sub-Zero refrigeration. We know these
            appliances inside and out and are committed to keeping them running
            smoothly, so your kitchen stays hassle-free.
          </p>
        </div>
      </div>
      <div
