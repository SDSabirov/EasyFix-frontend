<template>
    <section class="w-full h-full relative bg-white overflow-hidden  ">
      <img
        src="/assets/img/promotions/wolf-hero3.webp"
        alt="Wolf Appliances"
      ...
      >
        <div
          class="bg-white/60 md:backdrop-blur-sm p-6 md:p-10 rounded-2xl space-y-12 max-w-[549px] mx-2 z-20 md:py-20"
        >
          ...
          <ul class="text-xl md:text-2xl  leading-loose list-inside space-y-4">
            <li class="flex space-x-2">
              ...
              ><span>Wolf Ranges & Cooktops</span>
            </li>
            <li class="flex space-x-2">
              <span
                ><img
                  src="/assets/icons/starBullet.svg"
                  alt="star bullet points" /></span
              ><span>Wolf Microwaves & Speed Ovens</span>s
            </li>
            <li class="flex space-x-2">
              <span
                ><img
                  src="/assets/icons/starBullet.svg"
                  alt="star bullet points" /></span
              ><span>Wolf Ventilation Systems (Range Hoods & Downdrafts ) </span>
            </li>
            <li class="flex space-x-2">
              <span
                ><img
          ...
          <div class="w-full py-8">
            <a href="tel:4159414144" class="w-full md:w-1/3">
              <button
                ...
                aria-label="Call us for Wolf appliance repair services"
              >
