<template>
  <section class="w-full relative">
    <img
      src="/assets/img/promotions/map.png"
    ...
    <div
      class="rounded-full  border-2 outline-2 outline-dashed border-gray-400 h-[97%] w-[50%] bg-primary/60 absolute top-[2%] right-[10%] flex flex-col items-center justify-center"
    >
     <a
        href="/"
      ...
      >
        ...
        <div class="flex flex-col">
          ...
          <p
            class="self-center text-white text-sm md:text-xl font-normal whitespace-nowrap dark:text-white"
          >
