    ...
    <section class="py-10 sm:py-16 lg:py-32" style="background: linear-gradient(to bottom right, #f8fafc, #ffffff);">
      <div class="container mx-auto px-4 max-w-screen-xl">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center mb-10 sm:mb-20">
            ...
            <div class="space-y-6 text-lg leading-relaxed" style="color: #4b5563;">
              ...
              <div class="grid grid-cols-2 gap-4 mt-8">
                <div class="p-4 rounded-xl" style="background: rgba(249, 115, 22, 0.1);">
                  <div class="text-2xl font-bold mb-2" style="color: #f97316;">1919</div>
                  <div class="text-sm font-medium" style="color: #1f2937;">Heritage Since</div>
                </div>
                <div class="p-4 rounded-xl" style="background: rgba(249, 115, 22, 0.1);">
          ...
          <div class="relative">
            <img src="/assets/img/kitchenaidCover.webp" alt="KitchenAid professional kitchen appliances with iconic heritage design" class="w-full h-auto rounded-2xl shadow-2xl">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-8 sm:mt-12">
              <div class="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p class="text-sm" style="color: rgba(255, 255, 255, 0.8);">KitchenAid-authorized service technicians</p>
                </div>
              </div>
              ...
              <div class="flex items-start space-x-4">
                ...
                <div>
                  <h3 class="font-bold mb-2" style="color: #ffffff;">Genuine KitchenAid Parts</h3>
          ...
          <div class="relative">
            <div class="p-5 sm:p-8 rounded-3xl" style="background: linear-gradient(to bottom right, #1C6E8C, #f97316);">
              ...
              <div class="space-y-4">
                ...
                <div class="p-4 rounded-xl" style="background: rgba(255, 255, 255, 0.1); backdrop-filter: blur(8px);">
                  <h4 class="font-bold mb-2" style="color: #ffffff;">Ranges & Cooking Appliances</h4>
                  <ul class="text-sm space-y-1" style="color: rgba(255, 255, 255, 0.8);">
                    <li>• Range oven calibration</li>
                    <li>• Cooktop ignition issues</li>
                    <li>• Control panel replacements</li>
                    <li>• Even-heat system repairs</li>
                  </ul>
                </div>
                ...
                <div class="p-4 rounded-xl" style="background: rgba(255, 255, 255, 0.1); backdrop-filter: blur(8px);">
                  ...
                  <ul class="text-sm space-y-1" style="color: rgba(255, 255, 255, 0.8);">
                    <li>• Refrigerator temperature control</li>
                    <li>• Ice maker maintenance</li>
                    <li>• Dishwasher pump repairs</li>
...
// SEO optimization
useHead({
  title: 'KitchenAid Appliance Repair Services | Bay Area Home Chef Specialists',
  meta: [
    {
      name: 'description',
    ...
    {
      property: 'og:title',
      content: 'KitchenAid Appliance Repair Services | Bay Area Home Chef Specialists'
    },
    {
      property: 'og:description', 
      content: 'Factory-certified KitchenAid appliance repair services in the Bay Area. Home chef specialists with same-day service and genuine KitchenAid parts.'
    },
    {
      property: 'og:type',
      content: 'website'
  ...
  script: [
    {
      ...
      children: JSON.stringify({
        ...
        "@type": "LocalBusiness",
        "name": "Easy Fix Appliance - KitchenAid Repair Specialists",
        "description": "Factory-certified KitchenAid appliance repair services in the Bay Area",
        "url": "https://easyfixappliance.com/kitchenAid",
