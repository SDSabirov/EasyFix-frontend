<template>
  <header class="grain glow-brass relative bg-ink overflow-hidden">
    <img loading="eager" fetchpriority="high" decoding="async"
      ...
      alt="Wolf and Cove Appliances"
      class="absolute inset-0 w-full h-full object-cover opacity-40"
    />
    <div class="absolute inset-0 bg-gradient-to-r from-ink via-ink/70 to-ink/20" aria-hidden="true"></div>
    <span class="ghost-word ghost-word--light text-[6rem] lg:text-[11rem] bottom-2 -right-6" aria-hidden="true">Wolf</span>

    <div class="container mx-auto px-4 max-w-screen-xl relative z-10 pt-32 pb-20 lg:pt-48 lg:pb-32">
      <div class="max-w-2xl text-center md:text-left mx-auto md:mx-0">
        ...
        <h1 class="font-montserrat font-bold tracking-[-0.02em] text-4xl sm:text-5xl lg:text-6xl text-white leading-[1.05] mb-10">
          Wolf and Cove Appliance Repair
          <em class="block font-display font-semibold italic text-brass-light">in the Bay Area</em>
        </h1>
