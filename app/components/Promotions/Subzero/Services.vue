      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start mb-12 lg:mb-16">
        <div v-reveal>
          ...
          <h2 class="font-montserrat font-bold tracking-[-0.02em] text-3xl sm:text-4xl lg:text-5xl text-primary leading-[1.05]">
            ...
            <em class="block font-display font-semibold italic text-brass-dark">Sub-Zero Appliance Repairs?</em>
          </h2>
        </div>
...
const cards = [
  {
    ...
    description: 'Our technicians undergo rigorous training to handle Sub-Zero high-performance technology.',
  },
  {
    icon: headphoneIcon,
  ...
  },
  {
    ...
    description: 'We use genuine Sub-Zero parts and advanced diagnostics for precise, lasting repairs.',
  },
  {
    icon: wrenchIcon,
    iconAlt: 'wrench icon',
