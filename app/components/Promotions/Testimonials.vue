    ...
    >
      <div class="container mx-auto px-2 py-6 lg:px-28">
        ...
        >
          ...
          >
            <svg
              class="h-8 mx-auto mb-3 text-black dark:text-gray-600"
              viewBox="0 0 24 27"
              fill="none"
            ...
            <figcaption class="flex items-center justify-center mt-6 space-x-3">
              ...
              >
                ...
                ><p>
                  ...
                  <img loading="lazy" decoding="async" v-if="currentReview.platform=='Yelp'" src="/assets/img/yelp.svg" class="max-h-[30px]" alt="yelp logo">
                  <img loading="lazy" decoding="async" v-if="currentReview.platform=='Google'" src="/assets/img/google.svg" class="max-h-[30px]" alt="yelp logo">
                </div>
              </div>
            </figcaption>
          </figure>
