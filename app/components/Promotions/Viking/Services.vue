      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start mb-12 lg:mb-16">
        <div v-reveal>
          ...
          <h2 class="font-montserrat font-bold tracking-[-0.02em] text-3xl sm:text-4xl lg:text-5xl text-primary leading-[1.05]">
            ...
            <em class="block font-display font-semibold italic text-brass-dark">Viking Appliance Repairs?</em>
          </h2>
        </div>
        <div class="space-y-8" v-reveal="120">
          <p class="text-base sm:text-lg text-gray-600 leading-relaxed">
            At Easy Fix Appliance, we&rsquo;ve handled over 10,000 repairs, making us
...
const cards = [
  {
    ...
    description: 'Our technicians undergo rigorous training to handle Viking’s high-performance technology.',
  },
  {
    icon: headphoneIcon,
  ...
  },
  {
    ...
    description: 'We use genuine Viking parts and advanced diagnostics for precise, lasting repairs.',
  },
  {
    icon: wrenchIcon,
    iconAlt: 'wrench icon',
